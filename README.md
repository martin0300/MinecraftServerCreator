...
**Warning: This version of the javascript rewrite is discontinued! The new rewrite is on the beta-js branch.**
...
3. Clone this repository\
   `git clone -b old-beta-js https://github.com/martin0300/MinecraftServerCreator`
